...
@media (max-width: 400px) {
    ...
    .buying-selling {
		...
		$(document).ready(function(){
			$(".one td ").find("input[type='button']").click(function(){
				...
				$.ajax({
					...
					data: mydata,
	 		        success:function(data){
  					window.location.href="checkProduct.action";
				}
			});
		});
		});
  ...
  $( function() {
	...
	<body>
        ...
        <tbody>
            ...
            <tr style="text-align:center" class="one">
                 <td><s:property value="materialId"/></td>
             	 <td><s:property value="bookingDate"/></td>
             	  <td><s:property value="materialName"/></td>
             	   <td><s:property value="rateTone"/></td>
             	    <td><s:property value="quant"/></td>
             	   <td><input type="button" value='Delete' id='<s:property value="materialId"/>'/></td>
             </tr>
             </s:iterator>
         </tbody>
