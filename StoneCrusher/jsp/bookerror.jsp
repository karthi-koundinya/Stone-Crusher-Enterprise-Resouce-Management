...
<html>
	...
	<body>
		...
		<center><h4 style="color:red";font-weight:bold">Stock Not Available</h4></center>
			...
			<div class="bs-example" id="booking-div">
				<form id="fileUpload" action="bookMyRoom" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text"  name="cid" id="cid" class="form-control" readonly="readonly"/>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="kilometer" id="kiloe" class="form-control" />
					...
					<div class="row next-mater-wrap">
						<div class="col-xs-6">
							<input id="order" type="submit" class="btn btn-success" value="Order Material" style="float:right;"/>
						</div>
						<div class="col-xs-6">
