		...
		<div id="workarea"  class="col-sm-offset-1 col-sm-10">
			<div class="bs-example" id="booking-div">
				<form  action="delete" method="post" enctype="multipart/form-data">
					<h3 class="page-header" style="margin: 0;">Delete Employee Details</h3>
					...
					<div class="row next-mater-wrap">
						<div class="col-xs-6">
							<input id="order" type="submit" class="btn btn-success" value="Delete Employee" style="float:right;"/>
						</div>
						<div class="col-xs-6">
